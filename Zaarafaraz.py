...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mZAARA__FARAZ\033[1;91m-----------------»")
        ...
        love("\033[1;91m«------------------ZAARA_-_FARAZ----------------»")
        love("\033[1;95mB4Baloch 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mZAARA FARAZ\033[1;96m--------------»")
        time.sleep(0.3)
...
##### LOGO #####
logo = """
\033[1;96mPAK HACKERS░░░\033[1;92m░░░ZAARA--FARAZ╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══M4╗B4║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░B4_ZAARA_M4_MASTER╔╝
\033[1;96mPAKISTANI╦╝HACKERS\033[1;92m║░░░░░███████║██║░░╚═╝\033[1;91m█████═╝░
\033[1;96mWEBHACKER╔══ZAARA__--__FARAZ╗\033[1;92m██║░░░░░██╔══██║██║░░\033[1;91m██╗██╔═██╗░
\033[1;96mTHE--FOX\033[1;92m╦╝RESPECT-ME╗██║░░██║╚█\033[1;91m████╔╝██║░╚██╗
\033[1;96m╚═══\033[1;92m══╝░╚══════╝╚═╝░░╚═╝\033[1;91m░╚════╝░╚═╝░░╚═╝
\033[1;96mHACK\033[1;92mTHE╗░░░HACKERS╗░THE FOX╗░HACKERS\033[1;91m████╗██╗░█████╗░
\033[1;96mWE\033[1;92mARE╗░LEGION║WE╔══NEVER╗\033[1;91mFORGIVE╔════╝SPEED█║LIMIT█╔══INCREASED█╗
\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mB4║█THE FOX█╗░░M4║██MASTER██║
\033[1;92m██║╚██╔╝██║██╔\033[1;91m══██║██╔══╝░░██║██╔══██║
\033[1;92m██║░╚═╝░██║█\033[1;91m█║░░██║██║░░░░░██║██║░░██║
\033[1;92m╚═╝░░░░░╚═\033[1;91m╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
\033[1;47m\033[1;31m      PAKISTANI HACKER       \033[1;0m
\033[1;96m«-----------------\033[1;91mZAARA FARAZ LOVE\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  FOX
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  HACKER
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   ZAARA FARAZ
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ I LOVE YOU
\033[1;96m«-----------------\033[1;91mZAARA FARAZ THE FOX\033[1;96m-----------------»"""
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  ZAARA░░░░░░FARAZ░░PAKISTANI░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  ZAARA░░░░░FARAZ██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  THE FOX░░░░░I LOVE YOU░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON FACEBOOK░░ZAARA CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  HI, I AM ZAARA FARAZ A ETICAL HACKER | lolcat -a -F 0.1')
    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')
    os.system('echo  ZAARA FARAZ THE FOX = I LOVE YOU | lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL ZAARA FAARAZ ETHICAL HACKER | lolcat -a -F 0.1')
    ...
    os.system('echo ----------------ZAARA---FARAZ-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  ZAARA FARAZ| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  ZAARAHACKER| lolcat --animate')
    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')
    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   THE FOX| lolcat --animate')
    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈LOVE YOU| lolcat --animate')
    os.system('echo -----------------ZAARA---FARAZ----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo         Type python2 ZAARA.py| lolcat --animate')
    os.system('echo -----------------ZAARA FARAZ----------------| lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [W]  ZAARA FARAZ ETHICAL HACKAR FACEBOOK Group------------● | lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     ZAARA ")
                love("\033[1;93mTool Password  :\033[1;95m     FARAZ ")
                ...
                love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name PAKISTAN Password lovehacker")
                time.sleep(5)
                ...
                clear()
                print(logo)
                love("Welcome To ZAARA FARAZ 2nd Tool")
